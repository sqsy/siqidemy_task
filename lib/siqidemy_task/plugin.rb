...
module SiqidemyTask
  ...
  class Plugin < SiqidemyPlugin
    ...
    def setup
      # Add our Assets
      register_js('siqidemy_task')
      register_css('siqidemy_task')

      # Add the archetype
      register_archetype(SiqidemyTask::Plugin.archetype)
    ...
    module GuardianMixin
      ...
      def can_complete_task?(topic)
        ...
        return false unless topic.archetype == SiqidemyTask::Plugin.archetype
